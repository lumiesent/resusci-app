    ...
    */
    ...
    cpr_no_aed_loop: {
      on: {
        ...
        'intent.no_breathing': 'cpr_no_aed', // Powrót do RKO/AED jeśli pomyłka
        'intent.cpr.not_breathing': 'cpr_no_aed',
    ...
    aed_loop: {
      on: {
        ...
        'intent.no_breathing': 'aed_defib', // Powrót do RKO/AED jeśli pomyłka
        'intent.cpr.not_breathing': 'aed_defib',
